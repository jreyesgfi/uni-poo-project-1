...
public class Menu {
    ...
    /**
     * Crea un menú con los juegos de adivinar números.
     * @param juegosReunidosInstancia
     */
    ...
    /**
     * Método para jugar a un juego seleccionado, iterando dentro de él hasta superarlo
     * o perder todas las vidas.
     ...
     * Este muestra por pantalla los juegos disponibles y desencadena
     * el lanzamiento de estos al seleccionarlos.
     */
    public void ejecuta(){
        boolean jugando = true;
        while (jugando){
